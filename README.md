...
| `ContentTranslationGroup` | `contentTranslationGroups` | Translation group linking Contents. |
| `TagTranslationGroup` | `tagTranslationGroups` | Translation group linking Tags. |
