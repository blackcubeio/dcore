...
final class ContentTranslationCest
{
    ...
    public function _before(ModelsTester $I): void
    {
        ...
        // Setup: Get or create 3 languages
    ...
    public function testLinkToExistingGroup(ModelsTester $I): void
    {
        ...
        $translationEn = $this->contentFr1->getTranslationsQuery()->language('en')->one();
