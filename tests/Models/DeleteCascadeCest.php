...
final class DeleteCascadeCest
{
    ...
    // ========================================
    // Test 10 — Delete Content → TranslationGroup orphelin supprimé
    // ========================================

    public function testDeleteContentCascadesOrphanedTranslationGroup(ModelsTester $I): void
    {
        ...
        $I->assertNull(TranslationGroup::query()->andWhere(['id' => $groupId])->one());
    }

    // ========================================
    // Test 11 — Delete Content → TranslationGroup partagé NON supprimé
    // ========================================

    public function testDeleteContentKeepsSharedTranslationGroup(ModelsTester $I): void
    {
        $translationGroup = new TranslationGroup();
        $translationGroup->save();
        $groupId = $translationGroup->getId();
        ...
        $I->assertNotNull(TranslationGroup::query()->andWhere(['id' => $groupId])->one());
    }
