...
/**
 * M000000000008CreateContents.php
 *
 * PHP Version 8.1
 *
 ...
 * @link https://www.blackcube.io
 */
final class M000000000008CreateContents implements RevertibleMigrationInterface
{
    public function up(MigrationBuilder $b): void
    {
        ...
        $b->addForeignKey('{{%contents}}', 'contents__translationGroupId_fk', ['translationGroupId'], '{{%contentTranslationGroups}}', ['id'], 'SET NULL');
