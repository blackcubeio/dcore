...
/**
 * M000000000006CreateTypesElasticSchemas.php
 *
 * PHP Version 8.3+
 *
 ...
 * @link https://www.blackcube.io
 */
final class M000000000006CreateTypesElasticSchemas implements RevertibleMigrationInterface
{
    public function up(MigrationBuilder $b): void
    {
        $b->createTable('{{%types_elasticSchemas}}', [
            'typeId' => ColumnBuilder::bigint()->notNull(),
            'elasticSchemaId' => ColumnBuilder::integer()->notNull(),
