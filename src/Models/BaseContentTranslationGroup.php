...
/**
 * BaseContentTranslationGroup.php
 *
 * PHP Version 8.1
 *
...
/**
 * BaseContentTranslationGroup - Pure Yii3 ActiveRecord base class.
 ...
 * @link https://www.blackcube.io
 */
abstract class BaseContentTranslationGroup extends ActiveRecord
{
    ...
    {
        return '{{%contentTranslationGroups}}';
    }
