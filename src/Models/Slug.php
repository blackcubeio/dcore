...
class Slug extends ActiveRecord
{
    ...
    {
        return $this->hasOne($this->resolve(Xeo::class), ['slugId' => 'id'])->inverseOf('slug');
    }

    #[Exportable(name: 'sitemap')]
    public function getSitemapQuery(): ActiveQueryInterface
    {
        return $this->hasOne($this->resolve(Sitemap::class), ['slugId' => 'id'])->inverseOf('slug');
    }

    public function getContentQuery(): ActiveQueryInterface
    {
        return $this->hasOne($this->resolve(Content::class), ['slugId' => 'id'])->inverseOf('slug');
    }

    public function getTagQuery(): ActiveQueryInterface
    {
        return $this->hasOne($this->resolve(Tag::class), ['slugId' => 'id'])->inverseOf('slug');
    }
