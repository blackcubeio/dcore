...
```php
$bloc->getContentsQuery()->all()   // Contents this bloc is attached to
$bloc->getTagsQuery()->all()       // Tags this bloc is attached to
...
```php
$content->getBlocsQuery()->all()       // Bloc[] ordered by position
