...
All models use `ScopableQuery` via `Model::query()`. This query automatically detects model capabilities and exposes chainable filtering scopes.
...
`ScopableQuery` integrates tree filters. See [tree-structure.md](tree-structure.md) for details.
